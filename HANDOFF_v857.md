...
| | 状態 |
|---|---|
| 現行版 | **v857**。**v849〜v857 が GitHub 未 push**（v848 までは push 済み） |
| 検証 | `PASS=4690 / FAIL=0 / 実行=81/96`。検証96本・バックアップ76件 |
...
```bash
unzip funergy_v857_handoff.zip
tar -xJf handoff_v857.tar.xz
cd handoff_v857
...
```
合計 PASS=4690  FAIL=0  実行=81/96
合流ルールの未定義: 1
同期対象で未保護: 0
OP_SYNC_KEYS で未保護: 61
予算の対象月: 3 / 7
APP_VERSION=857 / SW_BUILD=857
CRLF=58167 / lone LF=0
```
