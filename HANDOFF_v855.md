...
| | 状態 |
|---|---|
| 現行版 | **v855**。**v849〜v855 が GitHub 未 push**（v848 までは push 済み） |
| 検証 | `PASS=4573 / FAIL=0 / 実行=79/94`。検証94本・バックアップ74件 |
...
```bash
unzip funergy_v855_handoff.zip
tar -xJf handoff_v855.tar.xz
cd handoff_v855
...
```
合計 PASS=4573  FAIL=0  実行=79/94
合流ルールの未定義: 1
同期対象で未保護: 0
予算の対象月: 3 / 7
APP_VERSION=855 / SW_BUILD=855
CRLF=58100 / lone LF=0
```
